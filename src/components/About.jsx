...
function About() {
  ...
  return (
    <div className="w-[75%] border border-gray-300 rounded-xl py-3 px-8 mb-5 max-sm:w-full animate-fade-right" onMouseOver={() => setIsHover(true)}  onMouseOut={() => setIsHover(false)}>
