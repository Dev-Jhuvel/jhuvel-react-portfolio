...
function Project(){
    ...
    return (
        <section className={`${darkTheme ? 'bg-[#161618]' : ''} w-full border border-gray-300 rounded-xl p-2 max-sm:w-full animate-fade-left animate-delay-2000 animate-duration-500 max-sm:animate-delay-2500`}>
