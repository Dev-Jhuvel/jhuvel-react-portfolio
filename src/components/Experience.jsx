...
function Experience() {
  ...
  return (
    <section
      className={`${darkTheme ? "bg-[#161618]" : ""} w-[30%] border border-gray-300 rounded-xl p-2 mb-5 max-sm:w-full animate-fade-left animate-delay-500 animate-duration-500 max-sm:animate-delay-1000`}
    >
